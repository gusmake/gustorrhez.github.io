...
<div align="center">
  <div id="contenido">
    ...
    <p>Con este número podrás seguir participando en el sorteo por un <b>iPhone X</b>. En breve recibirás en tu correo electrónico <b><? echo $row['email']; ?></b> este númer de participación.
    <p>Dentro de los próximos 60 días recibirás dos correos más para participar en las otras dos encuestas restantes. Recuerda que para poder ganar deberás haber respondido completas las 3 encuestas. ¡Ya completaste la primera! Sólo te faltan dos.</p>
    <p>El ganador será aquel concursante que haya registrado sus datos, contestado completas las 3 encuestas y cuyo folio de participación coincida con los últimos 4 dígitos del número ganador del Sorteo Especial de la Lotería Nacional del próximo 14 de noviembre de 2017.</p>
  </div>
