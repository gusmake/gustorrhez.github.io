...
<div align="center">
  ...
  <div id="contenido">
    ...
    <h1>Suscripción</h1>
    <p>Registra tus datos para poder participar en nuestras encuestas y podrás ganar diversos premios. Cada que haya una encuesta nueva, te enviaremos a través de tu WhatsApp el link de participación.</p>
    <p>Los datos que proporciones deberán ser verídicos y coincidir con tu identificación oficial, ya que podrán ser cotejados en caso de premios especiales, tales como viajes, smartphones y/o monederos electrónicos.</p>
    ...
    <ol>
      ...
      <? $date_start = date("Y")-82; $date_finish = date("Y")-18; ?>
      ...
      <div align="center"><input type="button" value="Suscribirme" onClick="valida_envia()" class="button"></div>
    </ol>
    </form>
  </div>
